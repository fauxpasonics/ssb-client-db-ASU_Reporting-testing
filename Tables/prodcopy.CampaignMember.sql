...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__CampaignM__CopyL__2D27B809] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[CampaignMember] ADD CONSTRAINT [PK__Campaign__3214EC0782589CA2] PRIMARY KEY CLUSTERED  ([Id])
GO
