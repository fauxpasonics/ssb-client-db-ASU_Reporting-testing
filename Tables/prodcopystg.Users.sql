CREATE TABLE [prodcopystg].[Users]
(
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_Users] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Users] ADD CONSTRAINT [PK__Users__3214EC07AFD1F67F] PRIMARY KEY CLUSTERED  ([Id])
GO
