...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__UserRole__CopyLo__5CD6CB2B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[UserRole] ADD CONSTRAINT [PK__UserRole__3214EC07C47BC939] PRIMARY KEY CLUSTERED  ([Id])
GO
