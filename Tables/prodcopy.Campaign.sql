...
[Total_Purchased__c] [float] NULL,
[Total_Purchase_Value__c] [float] NULL,
[Total_Seats_Sold__c] [float] NULL,
[Total_Amount_Paid__c] [float] NULL,
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Campaign__CopyLo__21B6055D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC0781010CC9] PRIMARY KEY CLUSTERED  ([Id])
GO
