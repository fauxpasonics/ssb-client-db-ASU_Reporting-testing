...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__778AC167] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Transactions__c] ADD CONSTRAINT [PK__Transact__3214EC07876D528B] PRIMARY KEY CLUSTERED  ([Id])
GO
