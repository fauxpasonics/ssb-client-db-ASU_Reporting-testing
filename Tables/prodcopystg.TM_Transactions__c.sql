CREATE TABLE [prodcopystg].[TM_Transactions__c]
(
...
[Total__c] [float] NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__TM_Transa__copyl__151B244E] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[TM_Transactions__c] ADD CONSTRAINT [PK__TM_Trans__3214EC0735315061] PRIMARY KEY CLUSTERED  ([Id])
GO
