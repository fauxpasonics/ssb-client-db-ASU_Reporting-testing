...
[Account_Status__c] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Hometown__c] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__3214EC07EE69CC9A] PRIMARY KEY CLUSTERED  ([Id]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_Account_IsDeleted_SSB_CRMSYSTEM_CONTACT_ID__c_Include] ON [prodcopy].[Account] ([IsDeleted], [SSB_CRMSYSTEM_CONTACT_ID__c]) INCLUDE ([CreatedDate]) WITH (DATA_COMPRESSION = PAGE)
GO
