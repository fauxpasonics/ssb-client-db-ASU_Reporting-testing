...
[IsDeleted] [bit] NULL,
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__CopyL__68487DD7] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[OpportunityContactRole] ADD CONSTRAINT [PK__Opportun__3214EC07B27DA7D2] PRIMARY KEY CLUSTERED  ([Id])
GO
