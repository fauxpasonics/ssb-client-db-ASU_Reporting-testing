...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Users__CopyLoadD__52593CB8] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Users] ADD CONSTRAINT [PK__Users__3214EC072E7E750C] PRIMARY KEY CLUSTERED  ([Id])
GO
