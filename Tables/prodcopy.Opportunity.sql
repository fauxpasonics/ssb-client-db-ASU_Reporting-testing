...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__CopyL__3E52440B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC0785CD129F] PRIMARY KEY CLUSTERED  ([Id])
GO
