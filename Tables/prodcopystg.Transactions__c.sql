CREATE TABLE [prodcopystg].[Transactions__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__75A278F5] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Transactions__c] ADD CONSTRAINT [PK__Transact__3214EC0750639263] PRIMARY KEY CLUSTERED  ([Id])
GO
