...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__RecordTyp__CopyL__440B1D61] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC07C181F48B] PRIMARY KEY CLUSTERED  ([Id])
GO
